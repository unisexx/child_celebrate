				        ...
				        <td bgcolor="#FFFFFF" class="main_content_blk">
				        		...
				        		<?php
				                    if($current_user->user_type_id == 6){ // เจ้าหน้าที่ประจำเขต
								       ...
								       // }else{
										...
										if(@$assessment->status != "" and @$assessment->status <> 0){
				        	...
				        	<style>
								...
								<div id="menubar">
									<nav>
								  <ul class="nav">
										<?if (in_array($current_user->user_type_id, array(1,6,7,8,9,10,11,13))):?>
										<li><a href="javascript:void(0)" onclick="return false;">บริหารจัดการศูนย์เด็กเล็ก / โรงเรียนอนุบาล</a>
											<ul>
												<?if (in_array($current_user->user_type_id, array(1,6,7,8,13))):?>
												...
												<li><a href="nurseries/register_form?nursery_type=2">สมัครเข้าร่วมโครงการโรงเรียนอนุบาลปลอดโรค</a></li>
												<?endif;?>
										...
										<li><a href="javascript:void(0)" onclick="return false;">เจ้าหน้าที่</a>
											<ul>
												...
												<li><a href="staffs?user_type_id=11&name=&nursery_name=&area_id=&province_id=&search=1">ตรวจสอบรายชื่อครูโรงเรียนอนุบาล</a></li>
												<?endif;?>
											</ul>
										</li>
										<?endif;?>
								    ...
								    <li><a href="javascript:void(0)" onclick="return false;">แบบคัดกรองโรค</a>
								      <ul>
										...
										<?endif;?>
										<?if (in_array($current_user->user_type_id, array(1,6,7,8,9,10,11,12,13))):?>
								    <li><a href="javascript:void(0)" onclick="return false;">E-learning</a>
								      <ul>
										...
										<?endif;?>
										<?if (in_array($current_user->user_type_id, array(1,6,7,8,9,10,11,13))):?>
								    <li><a href="javascript:void(0)" onclick="return false;">ระบบบันทึกข้อมูลกลุ่มอาการของโรคติดต่อในเด็ก</a>
											<ul>
												<li><a href="desease_watch/form">บันทึกข้อมูลกลุ่มอาการของโรคติดต่อในเด็ก</a></li>
												<li><a href="desease_watch/index">ตรวจสอบข้อมูลกลุ่มอาการของโรคติดต่อในเด็ก</a></li>
											</ul>
										</li>
										<?endif;?>
										<?if (in_array($current_user->user_type_id, array(1,6,7,8,9,10,11,13))):?>
										<li><a href="javascript:void(0)" onclick="return false;">รายงาน</a>
											<ul>
												...
												<li class="main_menu_nolink"><a href="javascript:void(0)" onclick="return false;">รายงานข้อมูลกลุ่มอาการของโรคติดต่อในเด็ก</a></li>
												<li class="sub_menu"><a class="sub_menu" href="reports/desease_watch_number">- รายงานจำนวนข้อมูลกลุ่มอาการของโรคติดต่อในเด็ก</a></li>
												<li class="sub_menu"><a class="sub_menu" href="reports/desease_watch_symptom">- รายงานกลุ่มอาการป่วยจากข้อมูลกลุ่มอาการของโรคติดต่อในเด็ก</a></li>
												<?endif;?>
												<?if (in_array($current_user->user_type_id, array(9,10,11))):?>
