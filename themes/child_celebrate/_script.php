...
<script src="media/js/jquery-validation-1.19.0/dist/jquery.validate.js"></script>
<script src="media/js/jquery-validation-1.19.0/dist/additional-methods.js"></script>
