...
<span><img src="images/ico_passed.png" width="24" height="24" /> <a href="#">ผ่านการตรวจสอบ (27)</a></span>
<span><img src="images/ico_reject.png" width="24" height="24" /> <a href="#">ไม่ผ่าน (2)</a></span>
<span><img src="images/ico_portfolio.png" width="24" height="24" /> <a href="#">ได้รับผลงานแล้ว (349)</a></span>
</div>
...
<tr>
  ...
  <th class="txtCen">รหัสตรวจสถานะ</th>
...
<tr class="odd">
  ...
  <td class="txtCen">&nbsp;</td>
  <td class="txtCen"><img src="images/ico_portfolio.png" width="32" height="32" class="vtip" title="รอการตรวจสอบ" /></td>
  <td><a href="<?=basename($_SERVER['PHP_SELF'])?>?act=form"><img src="images/edit.png" width="24" height="24" class="vtip" title="แก้ไขรายการนี้" /></a> <img src="images/remove.png" width="32" height="32" class="vtip" title="ลบรายการนี้"  /></td>
  </tr>
<tr>
  <td>5</td>
  ...
  <td class="txtCen">&nbsp;</td>
  <td class="txtCen"><img src="images/ico_portfolio.png" width="32" height="32" class="vtip" title="ผ่านการตรวจสอบ" /></td>
  <td><a href="<?=basename($_SERVER['PHP_SELF'])?>?act=form"><img src="images/edit.png" width="24" height="24" class="vtip" title="แก้ไขรายการนี้" /></a> <img src="images/remove.png" width="32" height="32" class="vtip" title="ลบรายการนี้"  /></td>
  </tr>
</table>
