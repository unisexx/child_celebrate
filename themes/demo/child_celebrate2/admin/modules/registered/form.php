...
<tr>
  ...
  <td><div class="form-inline">
    <select name="lunch" class="form-control" style="width:auto; background-color:#FFECFF">
      <option value="wait" selected="selected">รอการตรวจสอบ</option>
      <option value="pass">ผ่านการตรวจสอบ</option>
      <option value="reject">ไม่ผ่าน</option>
      <option value="portfolio">ได้รับผลงานแล้ว</option>
    </select>
    <input name="textarea2" type="text" class="form-control fdate" id="textarea" value="" style="width:120px; background-color:#FFECFF"/>
    <img src="images/calendar.png" />
<input name="input" type="button" title="บันทึกสถานะ" value="บันทึกสถานะ" class="btn btn-primary" style="width:100px;"/>

    <textarea name="textarea" cols="" rows="" id="remark" class="form-control" style="height:100px; margin-top:5px; background-color:#FFECFF"></textarea>
  </div></td>
</tr>
<tr>
...
<tr>
  <th>เจ้าของผลงาน  </th>
  <td>
  <span style="color:#C00; font-size:12px;">หากข้าพเจ้าได้รับการคัดเลือกเข้ารับพระราชทานรางวัล  ยินดีเข้าร่วมกิจกรรมกับกรมกิจการเด็กและเยาวชน ขอรับรองว่าผลงานและเอกสารที่เสนอข้างต้นเป็นความจริงทุกประการ</span>
  <input name="textarea7" type="text" class="form-control" id="textarea7" value="" style="width:300px;" placeholder="ชื่อเจ้าของผลงาน"/>
  </td>
</tr>
<tr>
...
<tr>
  ...
  <td>
  <textarea name="" cols="" rows="" class="form-control" placeholder="ความเห็นสนับสนุนด้านศีลธรรม จริยธรรม และคุณธรรม ของผู้เสนอ/ผู้รับรอง ที่มีต่อผู้สมัครฯ"></textarea>
  </td>
</tr>
</table>
</fieldset>
