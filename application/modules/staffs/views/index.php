...
<form method="get" action="staffs">
	...
	<?=form_dropdown('user_type_id',array('9'=>'เจ้าหน้าที่ศูนย์','10'=>'เจ้าหน้าที่ครู / ผู้ดูแลเด็ก','11'=>'เจ้าหน้าโรงเรียนอนุบาล'),@$_GET['user_type_id'],'','--- เลือกเจ้าหน้าที่ ---');?>
            ...
            <td>
            	<?
            		if($user->user_type_id == 9){
            			echo "เจ้าหน้าที่ศูนย์";
            		}elseif($user->user_type_id == 10){
            			echo "เจ้าหน้าที่ครู / ผู้ดูแลเด็ก";
            		}elseif($user->user_type_id == 11){
            			echo "เจ้าหน้าที่โรงเรียนอนุบาล";
            		}
             	?>
            </td>
            <!-- <td><?=$user->email?></td> -->
