        ...
        <form id="regisform" class="form-horizontal" method="post" action="staffs/save/<?=$user->id?>">
            ...
            <div class="control-group">
                <div class="controls">
                  ...
                  <input type="hidden" name="province_id" value="<?=$_GET['province_id']?>">
                  <input type="hidden" name="amphur_id" value="<?=$_GET['amphur_id']?>">
                  <input type="hidden" name="district_id" value="<?=$_GET['district_id']?>">
