...
<div id="data">
	...
	<div class="headsection">ข้อมูลของศูนย์เด็กเล็ก</div>
        ...
        <form id="regisform" class="form-horizontal" method="post" action="users/signup_center/<?=$nursery->id?>">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                  <input class="input-xlarge" type="text" name="nursery_name" value="<?=$nursery->name?>" placeholder="ชื่อศูนย์เด็กเล็ก">
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                  <input class="input-xlarge" type="text" name="number" value="<?=$nursery->number?>" style="width:50px;" placeholder="เลขที่">
                </div>
            </div>
            ...
            <div class="control-group">
                <label class="control-label">เบอร์ติดต่อศูนย์ <span class="TxtRed">*</span></label>
                <div class="controls">
                  <input class="input-xlarge" type="text" name="p_tel" value="<?=$nursery->p_tel?>" placeholder="เบอร์ติดต่อศูนย์">
                </div>
            </div>
            <hr>
