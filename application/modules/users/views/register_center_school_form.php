...
$(document).ready(function(){
	$("select[name='province_id']").live("change",function(){
		$("#district > select").val('').prop('disabled', 'disabled');
    ...
    messages:
    {
    	...
    	nursery_name:{required: "กรุณากรอกชื่อศูนย์เด็กเล็ก"},
    	username:{required: "กรุณากรอกยูสเซอร์เนม", minlength: "กรุณากรอกรหัสผ่านอย่างน้อย 4 ตัวอักษร"},
			fullname:{required: "กรุณากรอกชื่อผู้ลงทะเบียน"},
...
<div id="data">
	...
	<div class="headsection">ข้อมูลของโรงเรียนอนุบาล</div>
        ...
        <form id="regisform" class="form-horizontal" method="post" action="users/signup_center/<?=$nursery->id?>">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                  <input class="input-xlarge" type="text" name="nursery_name" value="<?=$nursery->name?>" placeholder="ชื่อโรงเรียนอนุบาล">
                </div>
            </div>

            <div class="control-group">
                <label class="control-label">เลขที <span class="TxtRed">*</span>่</label>
                <div class="controls">
                  <input class="input-xlarge" type="text" name="number" value="<?=$nursery->number?>" style="width:50px;" placeholder="เลขที">
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                  <input class="input-xlarge" type="text" name="moo" value="<?=$nursery->moo?>" style="width:50px;" placeholder="หมู่">
                </div>
            </div>
                ...
                <div class="controls">
                  <?php echo form_dropdown('province_id',get_option('id','name','provinces order by name asc'),@$nursery->province_id,'','--- เลือกจังหวัด ---') ?>
					...
					<div id="amphur" style="margin-top:10px;">
						...
						<?php else:?>
							<select name="amphur_id" disabled="">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                  <input class="input-xlarge" type="text" name="code" value="<?=$nursery->code?>" placeholder="รหัสไปรษณีย์">
                </div>
            </div>
            ...
            <div class="control-group">
                <label class="control-label">เบอร์ติดต่อโรงเรียน <span class="TxtRed">*</span></label>
                <div class="controls">
                  <input class="input-xlarge" type="text" name="p_tel" value="<?=$nursery->p_tel?>" placeholder="เบอร์ติดต่อโรงเรียน">
                </div>
            </div>
            <hr>

						<div class="headsection">ข้อมูลส่วนตัวผู้ลงทะเบียน ใช้สำหรับล้อกอินเข้าสู่ระบบ</div>

						<div class="control-group">
                <label class="control-label">ชื่อ - นามสกุล <span class="TxtRed">*</span></label>
                <div class="controls">
                  <input class="input-xlarge" type="text" name="fullname" value="<?=@$user->p_name?>" placeholder="ชื่อ - นามสกุล">
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?=form_dropdown('sex',array('ชาย'=>'ชาย','หญิง'=>'หญิง'),'','class="input-xlarge"','--- เลือกเพศ ---');?>
						...
						<div class="control-group">
                <label class="control-label">ตำแหน่ง <span class="TxtRed">*</span></label>
                <div class="controls">
                  <input class="input-xlarge" type="text" name="position" value="<?=@$user->position?>" placeholder="ตำแหน่ง">
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                  <input class="input-xlarge" type="text" name="phone" value="<?=@$user->phone?>" placeholder="เบอร์ติดต่อ">
                </div>
            </div>
