...
<ul class="breadcrumb">
      ...
      <li class="active">ข้อมูลกลุ่มอาการของโรคติดต่อในเด็ก</li>
</ul>


<!-- Search box. -->
<div id="data">
      <h4>ข้อมูลกลุ่มอาการของโรคติดต่อในเด็ก</h4>
...
<?php echo anchor('desease_watch/form', 'เพิ่มข้อมูลกลุ่มอาการของโรคติดต่อในเด็ก', 'class="btn btn-primary pull-right"'); ?>
</div>
