...
<!-- Content -->
<form id="desease_watch" action='desease_watch/result_demo' method='post'>
      ...
      <table class='tblForm table table-bordered'>
            ...
            <tr>
                  <td>
                        <select name="place_type" class="form-control" disabled="disabled">
                            <option value="">-- ระบุแหล่งเกิดโรค --</option>
														<option value="2" <?php echo $selected = 'selected="selected"';?>>พื้นที่ชุมชน</option>
            ...
            <tr class="tr_school" style="display:<?php echo $display;?>">
                  <td>
                        ...
                        <div>
                              ...
                              <input type="text" id="nurseryName" disabled="disabled" style="width:350px;" value="<?php echo @$rs -> nursery -> name; ?>" placeholder="ชื่อศูนย์เด็กเล็ก/โรงเรียนอนุบาล">
            ...
            <tr><th> 3. เด็กป่วย มีอาการดังนี้ </th></tr>
            <tr>
                  <td>
                        <?php
                                    ...
                                    <span class='errorPlace_questionParent'></span>
															...
															<div id="questionChoiceArea">
																<div style='padding-left:20px;'>
																        <div>
																              <div><?php echo form_checkbox('qCbox_1', 1, 1, 'class="questionParent"') . ' ไข้'; ?></div>
																              <div class="questionChild">
																                    <div>ลักษณะที่พบ</div>
																                    <?php echo form_radio('qRdo_1', 1, 1); ?> ไข้ต่ำๆ (<u><</u> 38.5 องศาเซลเซียส)
																                    <?php echo form_radio('qRdo_1', 2, @$q['qRdo_1']); ?> ไข้สูง (> 38.5 องศาเซลเซียส)
																              </div>
																        </div>

																        <div>
																              <div><?php echo form_checkbox('qCbox_2', 1,1, 'class="questionParent"') . ' ไอ'; ?></div>
																              <div class='questionChild'>
																                    <div>ลักษณะที่พบ</div>
																                    <?php echo form_radio('qRdo_2', 1, 1); ?> ไอห่าง ๆ
																        ...
																        <div>
																              <?php echo form_checkbox('qCbox_6_1', 1, 1, 'class="questionRequire"') . ' หายใจลำบาก'; ?>
																        ...
																        <div>
																              ...
																              <div class='questionChild'>
																				...
																				<div>
																              <div><?php echo form_checkbox('qCbox_13', 1, @$q['qCbox_13'], 'class="questionParent"') . ' มีตาแดง'; ?></div>
																              <div class="questionChild">
																                    <div>ลักษณะที่พบ</div>
																                    <?php echo form_radio('qRdo_13', 1, @$q['qRdo_13']); ?> ข้างขวาข้างเดียว
																                    <?php echo form_radio('qRdo_13', 2, @$q['qRdo_13']); ?> ข้างซ้ายข้างเดียว
																                    <?php echo form_radio('qRdo_13', 3, @$q['qRdo_13']); ?> ทั้ง 2 ข้าง
																              </div>
																        </div>
																        <div>
																              <?php echo form_checkbox('qCbox_14_1', 1, @$q['qCbox_14_1'], 'class="questionRequire"') . ' ตาแฉะ, ตาเยิ้ม'; ?>
																              <?php echo form_checkbox('qCbox_14_2', 1, @$q['qCbox_14_2'], 'class="questionRequire"') . ' มีเลือดออก'; ?>
																              <?php echo form_checkbox('qCbox_14_3', 1, @$q['qCbox_14_3'], 'class="questionRequire"') . ' มีหนองที่ตา'; ?>
																        </div>

																        <div>
																              <div><?php echo form_checkbox('qCbox_15', 1, @$q['qCbox_13'], 'class="questionParent"') . ' มีตุ่มหนองที่ตา'; ?></div>
																              <div class="questionChild">
																                    <div>ลักษณะที่พบ</div>
																                    <?php echo form_radio('qRdo_15', 1, @$q['qRdo_15']); ?> เปลือกตาบน
																                    <?php echo form_radio('qRdo_15', 2, @$q['qRdo_15']); ?> เปลือกตาล่าง
																                    <?php echo form_radio('qRdo_15', 3, @$q['qRdo_15']); ?> เปลือกตาบนและล่าง
																              </div>
																        </div>

																        <div>
																              <?php echo form_checkbox('qCbox_16_1', 1, @$q['qCbox_16_1'], 'class="questionRequire"') . ' เคืองตา, แสบตา'; ?>
																              <?php echo form_checkbox('qCbox_16_2', 1, @$q['qCbox_16_2'], 'class="questionRequire"') . ' ปวดตา'; ?>
																              <?php echo form_checkbox('qCbox_16_3', 1, @$q['qCbox_16_3'], 'class="questionRequire"') . ' ตามัว'; ?>
																        </div>
																</div>
...
<script type="text/javascript">
	$(function() {
		...
		$('#btnNurserySubmitSearch').live('click', function() {
			...
			nursery_type = $('#nurseries_list').find('div.modal-body').find('[name=nursery_type] option:selected').val();
      ...
      $(document).ready(function(){
        ...
        $("select[name=place_type]").live("change",function(){
            ...
            switch(place_type){
				...
				$('input[type=radio],input[type=text],input[type=select],input[type=checkbox]').attr('disabled','disabled');
      });
</script>
