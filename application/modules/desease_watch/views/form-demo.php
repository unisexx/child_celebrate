...
<form id="desease_watch" action='desease_watch/result_demo' method='post'>
      ...
      <table class='tblForm table table-bordered'>
            ...
            <tr>
                  <td>
												<input type="radio" name="rdo_doctor_case" value="1"> กรณีที่แพทย์วินิจฉัยระบุโรคที่เกิดกับเด็กแล้ว
												<div class="disease" style="display:inline;">
												โปรดระบุโรค
                        <?php
                        ...
                        ?>
												...
												<br><br>
												<input type="radio" name="rdo_doctor_case" value="2"> กรณีที่แพทย์ยังไม่ได้วินิจฉัยระบุโรคที่เกิดกับเด็ก<br>
                        <div class="question" style='line-height:25px;padding-left:50px;'>
															กรุณาระบุอาการ <br>
                              <div class="">
...
<script type="text/javascript">
	$(function() {
		$(".disease").hide();
		$('[name=rdo_doctor_case]').click(function(){
				var doctor_case = $('[name=rdo_doctor_case]:checked').val();
				if(doctor_case=="1"){
						$('.disease').show();
						$('.question').hide();
				}else if(doctor_case=="2"){
					$('.disease').hide();
					$('.question').show();
				}else{
					$('.disease').hide();
