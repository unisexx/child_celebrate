...
<form id="search_report" method="get" action="nurseries/reports/index/basic_column">
	<div>
		...
		<?=form_dropdown('nursery_type',array(''=>'ทั้งหมด','1'=>'ศูนย์เด็กเล็ก','2'=>'โรงเรียนอนุบาล'),@$_GET['nursery_type'],'');?>
		<?=form_dropdown('search_type',array('1'=>'ค้นหาย้อนหลัง 3 ปี','2'=>'ค้นหาระหว่างปี'),@$_GET['search_type'],'');?>
		
		<?=form_dropdown('three_year',array('2559'=>'2559','2560'=>'2560'),@$_GET['three_year'],'');?>
		<?=form_dropdown('start_year',array('2554'=>'2554','2555'=>'2555','2556'=>'2556','2557'=>'2557','2558'=>'2558','2559'=>'2559','2560'=>'2560'),@$_GET['start_year'],'','--- ปีที่เริ่ม ---');?>
		<?=form_dropdown('end_year',array('2554'=>'2554','2555'=>'2555','2556'=>'2556','2557'=>'2557','2558'=>'2558','2559'=>'2559','2560'=>'2560'),@$_GET['end_year'],'','--- ปีที่สิ้นสุด ---');?>
	</div>
	<div>
		<span>แยกตาม</span>
